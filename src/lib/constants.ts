...
export const QUIZ_CATEGORIES = [
  ...
  { slug: "vocabulary", label: "語彙問題", description: "Part 5形式の語彙・語法問題", icon: "📚", questionCount: 120 },
] as const;
...
export const LISTENING_CATEGORIES = [
  { slug: "part1", label: "Part 1: 写真描写", description: "写真を見て正しい描写を選ぶ", icon: "🖼️" },
  { slug: "part2", label: "Part 2: 応答問題", description: "質問に対する適切な応答を選ぶ", icon: "💬" },
  { slug: "part3", label: "Part 3: 会話問題", description: "会話を聞いて質問に答える", icon: "🗣️" },
] as const;
